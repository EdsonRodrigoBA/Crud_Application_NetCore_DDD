...
namespace PortalCompras.Produtos.boundedContext.Infrastructure.Configurations
{
    ...
    /// </summary>
    public class ProdutosMysqlDbContext : DbContext, IUnitOfWork
    {
        public ProdutosMysqlDbContext()
        {

        }
        public ProdutosMysqlDbContext(DbContextOptions<ProdutosMysqlDbContext> options) : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(ProdutosMysqlDbContext).Assembly);
