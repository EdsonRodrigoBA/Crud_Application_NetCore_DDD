...
namespace PortalCompras.Produtos.boundedContext.ProdutosWebApi.Controllers
{
    ...
    /// <summary>
    /// LEsta classe foi desenvolvida pra testar a Api Usando a Base de dados SQLLite
    /// </summary>
    /// <remarks>
    /// 
    /// </remarks>
    ...
    [ApiController]
    public class ProdutosSqlLiteController : ControllerBase
    {
        ...
        public ProdutosSqlLiteController(IProdutoServices produtoServices, IValidator<ProdutoViewModel> validator)
        {
        ...
        public async Task<IActionResult> Get(int limite =50, int offset = 1)
        {
            ...
            var produtos = await _produtoServices.ListarTodosSqlLite(offset, limite);
        ...
        public async Task<IActionResult> Get(Guid id)
        {
            ...
            var produtos = await _produtoServices.BuscarPorIdSqlLite(id);
            if(produtos == null)
            {
                return NoContent();
            }
        ...
        public async Task<IActionResult> Post(ProdutoViewModel model)
        {
            ...
            model.Id = Guid.Empty;
            var produto = await _produtoServices.AdicionarSqlLite(model);
        ...
        public async Task<IActionResult> Putt(ProdutoViewModel model)
        {
            ...
            var produto = await _produtoServices.AtualizarSqlLite(model);
            return StatusCode(StatusCodes.Status201Created, produto);
        }
        ...
        public async Task<IActionResult> Delete(Guid id)
        {
            ...
            var produto = await _produtoServices.ExcluirSqlLite(id);
